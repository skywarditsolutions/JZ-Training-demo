...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path, server_url: str):
...
#------------ THE LLM TOOL CALL IS DIFFERENT FROM TOOL_CALL
    ...
    def send_message(self, document_content: str, user_message: Optional[str] = None, messages: Optional[list[dict[str,str]]] = None):
        ...
        return response #DO I ADD .CONTENT AFTER RESPONSE

    def process_LLM_response(self, response):
        pass

    
    # --------- THIS IS VERY DIFFERENT IDK WHAT TO ADD 
...
# ------ I DIDNT PASTE ANYTHING BECAUSE WE DIDNT MAKE ANY CHANGES BEFORE
async def main():
    client = MCPClient()
